...
btn.setOnAction(new EventHandler(){
            ...
            public void handle(Event event) {
                ...
                Player1.roll_dice(Dice[0], Dice[1], Dice[2]);
                
                //Create Text to label the game die in GUI
                String Str_Die1Value = Integer.toString(Player1.get_roll().get_die_top(1));
                Text Die1Value = new Text(Str_Die1Value);
                
                String Str_Die2Value = Integer.toString(Player1.get_roll().get_die_top(2));
                Text Die2Value = new Text(Str_Die2Value);
                
                String Str_Die3Value = Integer.toString(Player1.get_roll().get_die_top(3));
                ...
                if(Player1.rolled_instant_win()){
                    System.out.println("You Rolled an Instant Win! \n Game Over!");
                }
                else if(Player1.rolled_instant_loss()){
                    //react to instant loss roll
                }
                else if(Player1.rolled_trips()){
                    //react to rolled trips
                }
                else if(Player1.rolled_pair()){
                    Player1.set_point();
                }
